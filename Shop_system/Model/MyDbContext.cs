    ...
    internal class MyDbContext : DbContext
    {
        ...
        new Admin
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { ProductId = 1, ProductName = "White Bread | 700g", Price = 4.40m, CategoryId = 2, Stock = 100 },
                new Product { ProductId = 2, ProductName = "Chicken Breast | 600g", Price = 8.40m, CategoryId = 3, Stock = 20},
                new Product { ProductId = 3, ProductName = "Blueberries | 170g", Price = 2.50m, CategoryId = 1, Stock = 50}
                );
